                                        ...
                                        <tr key={patient.id} className="group hover:bg-slate-50/80 dark:hover:bg-slate-800/40 transition-colors cursor-default">
                                            ...
                                            <td className="px-8 py-5 text-right">
                                                <Link
                                                    ...
                                                    className="inline-block px-6 py-2.5 bg-slate-900 text-white dark:bg-white dark:text-slate-900 rounded-xl font-black text-xs uppercase tracking-widest hover:scale-105 transition-all shadow-md group-hover:bg-blue-600 group-hover:text-white"
                                                >
                                                    VIEW DETAILS
                                                </Link>
                                            </td>
